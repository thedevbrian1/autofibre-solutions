                            ...
                            <ul className='list-none text-center mr-4 text-white'>
                                ...
                                <li className="hover:text-red-600 transition duration-300 ease-in-out">
                                    <NavLink
                                        ...
                                        prefetch="intent"
                                        className={({ isActive }) => isActive ? 'text-brand-yellow' : ''}
                                    >
                                        Home
                                    </NavLink>
                                </li>
                                <li className="hover:text-red-600 transition duration-300 ease-in-out">
                                    <NavLink
                                        ...
                                        prefetch="intent"
                                        onClick={() => setHash()}
                                        className={({ isActive }) => (isActive && hash !== 'contact') ? 'text-brand-yellow' : ''}
                                    >
                                        About
                                    </NavLink>
                                </li>
                                <li className="hover:text-red-600 transition duration-300 ease-in-out">
                                    <NavLink
                                        ...
                                        className={({ isActive }) => (isActive && hash === 'products') ? 'text-brand-yellow' : ''}
                                    >
                                        Products
                                    </NavLink>
                                </li>
                                <li className="hover:text-red-600 transition duration-300 ease-in-out">
                                    <NavLink
                                        ...
                                        className={({ isActive }) => (isActive && hash === 'services') ? 'text-brand-yellow' : ''}
                                    >
                                        Services
                                    </NavLink>
                                </li>
            ...
            <ul className="text-white hidden lg:flex gap-6">
                ...
                <li className="hover:text-brand-yellow transition duration-300 ease-in-out">
                    <NavLink
                        ...
                        prefetch="intent"
                        className={({ isActive }) => isActive ? 'text-[#ed9632]' : path === '/about' ? 'text-black' : ''}
                    >
                        Home
                    </NavLink>
                </li>
                <li className="hover:text-brand-yellow transition duration-300 ease-in-out">
                    <NavLink
                        ...
                        prefetch="intent"
                        onClick={() => setHash()}
                        className={({ isActive }) => (isActive && hash !== 'contact') ? 'text-[#ed9632]' : path === '/about' ? 'text-black' : ''}
                    >
                        About
                    </NavLink>
                </li>
                <li className="hover:text-brand-yellow transition duration-300 ease-in-out">
                    <NavLink
                        ...
                        prefetch="intent"
                        onClick={() => setHash('products')}
                        className={({ isActive }) => (isActive && hash === 'products') ? 'text-[#ed9632]' : path === '/about' ? 'text-black' : ''}
                    >
                        Products
                    </NavLink>
                </li>
                <li className="hover:text-brand-yellow transition duration-300 ease-in-out">
                    <NavLink
                        ...
                        prefetch="intent"
                        onClick={() => setHash('services')}
                        className={({ isActive }) => (isActive && hash === 'services') ? 'text-[#ed9632]' : path === '/about' ? 'text-black' : ''}
                    >
                        Services
                    </NavLink>
                </li>
